        ...
        try {
            ...
            GlobalTechInc.ev.on("connection.update", async (s) => {
                ...
                if (connection === "open") {
                    ...
                    stringSession = 'POPKID-V2-MD~' + stringSession;  // Prepend your name to the session ID
                    ...
                    await GlobalTechInc.sendMessage(userJid, { text: '`HELLO THERE! 👋` \n\n`DO NOT SHARE YOUR SESSION ID WITH ANYONE.`\n\n`PUT THE ABOVE IN SESSION_ID VAR`\n\n`THANKS FOR USING POPKID-V2-MD BOT`\n\n `JOIN SUPPORT CHANNEL:-https://whatsapp.com/channel/0029VadQrNI8KMqo79BiHr3l` \n' });
